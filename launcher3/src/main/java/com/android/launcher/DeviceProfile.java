...
public class DeviceProfile {
    ...
    public void layout(Launcher launcher) {
        ...
        //是布局生效searchBar.setLayoutParams(lp);
        ...
        Logger.e("距离" +  padding.left + "   " + padding.right + "    " + padding.top + "  " + padding.bottom);
        workspace.setLayoutParams(lp);
        /**
         * workspace 区域小 修改
         * 此Padding的值
         */
        workspace.setPadding(10, 20, 10, padding.bottom);
        //设置页间距
