...
import com.android.launcher.config.ProviderConfig;
import com.android.launcher.LauncherSettings.Favorites;
import com.android.launcher.utils.UIUtils;
...
public class LauncherProvider extends ContentProvider {
    ...
    synchronized public void loadDefaultFavoritesIfNecessary() {
        ...
        Logger.e(" EMPTY_DATABASE_CREATED     " + sp.getBoolean(EMPTY_DATABASE_CREATED, false));
...
//
//            String favoritesXml = getFavoritesXml(getContext());
//            mOpenHelper.loadFavorites(mOpenHelper.getWritableDatabase(), loader, favoritesXml);
//
////
            if (loader == null) {
...
//                if (partner != null && partner.hasDefaultLayout()) {
                    ...
                    int workspaceResId = partnerRes.getIdentifier(getFavoritesXml(getContext()),
...
//                }
    ...
    private String getFavoritesXml(Context context) {

        if(UIUtils.getInstance().getCompany().equals("huawei") || UIUtils.getInstance().equals("HUAWEI")){

        }
        return "default_workspace_4x4.xml";
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements AutoInstallsLayout.LayoutParserCallback {
        ...
        DatabaseHelper(Context context) {
            ...
            Logger.e(mMaxItemId + "  " + mMaxScreenId);
         ...
         * @return
         */
        private int loadFavorites(SQLiteDatabase db, AutoInstallsLayout loader, String favoritesXml) {
            ArrayList<Long> screenIds = new ArrayList<Long>();
            // TODO: Use multiple loaders with fall-back and transaction.
            int count = loader.loadLayout(db, screenIds);
