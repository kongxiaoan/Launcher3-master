...
import com.android.launcher.FolderIcon.FolderRingAnimator;
import com.android.launcher.Launcher.CustomContentCallbacks;
import com.android.launcher.Launcher.LauncherOverlay;
...
public class Workspace extends SmoothPagedView
    ...
    private void enableOverviewMode(boolean enable, int snapPage, boolean animated) {
        Logger.w(enable + "  ======>snapPage  " + snapPage + "  " + animated);

        Log.e("======>snapPage", snapPage + "");
    ...
    void startDrag(CellLayout.CellInfo cellInfo) {
        ...
        child.setVisibility(INVISIBLE);//设置拖拽对象在原来的位置不可见
    ...
    public void beginDragShared(View child, DragSource source) {
        ...
        final Bitmap b = createDragBitmap(child, padding); //创建拖拽对象
